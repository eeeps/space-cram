...
<li class="last leaf"><a href="http://www.wbshop.com/?ref=PWBCOMNAV&amp;utm_source=warnerbros.com&amp;utm_medium=referral&amp;utm_campaign=PWBCOMNAV" title="WB Shop Site" target="_blank">Shop</a></li>
  ...
  <div class="views-exposed-widgets clearfix">
          ...
          <div class="form-item form-item-qt form-type-textfield form-group"><input placeholder="search" class="form-control form-text" type="text" id="edit-qt" name="qt" value="archive spacejam movie www warnerbros com" size="30" maxlength="128" /></div>        </div>
              </div>
...
<h4 class="element-invisible">Error message</h4>
 <ul>
  <li>The page you requested does not exist. For your convenience, a search was performed using the query archive spacejam movie www warnerbros com.</li>
  <li>The page you requested does not exist. For your convenience, a search was performed using the query archive spacejam movie www warnerbros com.</li>
 </ul>
</div>
  ...
  <div class="view view-search view-id-search view-display-id-page wb-search throber-loader view-dom-id-199f6ca6e54ea53750df198b15c42266">
            <h2 class="heading">
      <strong>Search:</strong> <span class="searched-text">archive spacejam movie www warnerbros com</span>
    </h2>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"71ae714c72","applicationID":"51791634","transactionName":"Z1UDYUNSXEtTVEAMV14fIFZFWl1WHUFdAE9DbxFUVlY=","queueTime":0,"applicationTime":943,"atts":"SxIAFwtIT0U=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
